...
final class RMEpisodeListViewViewModel: NSObject {
    ...
    private var apiInfo: RMGetAllEpisodesResponseModal.Info? = nil

    /// Fetch initial set of episodes (20)
    public func fetchEpisodes() {
        RMService.shared.execute(
            .listEpisodesRequest,
            expecting: RMGetAllEpisodesResponseModal.self
        ) { [weak self] result in
            switch result {
    ...
    public func fetchAdditionalEpisodes(url: URL) {
        ...
        RMService.shared.execute(request, expecting: RMGetAllEpisodesResponseModal.self) { [weak self] result in
...
extension RMEpisodeListViewViewModel: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: RMCharacterEpisodeCollectionViewCell.identifer,
            for: indexPath
